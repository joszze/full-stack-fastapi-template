...
import type { Body_login_login_access_token,Message,NewPassword,Token,UserPublic,UpdatePassword,UserCreate,UserRegister,UsersPublic,UserUpdate,UserUpdateMe,ItemCreate,ItemPublic,ItemsPublic,ItemUpdate,ChatMessagesPublic } from './models';
...
export class ChatService {
	 ...
	 * @throws ApiError
	 */
	public static getMessages(): CancelablePromise<ChatMessagesPublic> {
				return __request(OpenAPI, {
			method: 'GET',
			url: '/api/v1/chat/',
		});
